...
class PriceTests {
    ...
    void price_cannot_be_negative_number() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> Price.ofDollar(-1));
    }

    @Test
    void price_must_have_at_most_two_decimals() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> Price.ofDollar(1.999f));
    }

    @Test
    void price_currency_must_be_valid() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Price(1.99f, "xyz"));
    }

    @Test
    void price_do_not_accept_null_currency() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Price(1.99f, null));
    }
    ...
    void add_prices_must_have_same_currency() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> p1.add(p2));
    }
